...
const moduleGame2 = createElement(`<header class="header">
...
const gameOptions = moduleGame2.querySelectorAll(`.game__option input`);
// what is better to use for loop 'for' or 'map' ?

// gameOptions[0].addEventListener(`click`, () => {
...
const backBtn = moduleGame2.querySelector(`.back`);
